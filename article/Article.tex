...
Note that there are actually a variety of ways in which scale can be
defined for PSFs, including $f(x) =  (\frac{x}{scale})^2$ and $f(x) =  (\frac{x^2}{scale})$. Logarithmic scales are another alternative.
